...
print("\n" + "="*60)
print("LAUNCHING TRAINING PIPELINE (v4 - with demonstration seeding)")
print("="*60)
...
for global_step in range(max_steps):
    ...
    if (global_step + 1) % 10000 == 0:
        ...
        torch.save(checkpoint, f"checkpoints/checkpoint_v4_{global_step}.pt")
...
torch.save(final_checkpoint, f"checkpoints/checkpoint_v4_final_{global_step}.pt")
